...
* Bug fixed: Comment updating now posts and displays properly
* Bug fixed: User comment delete issue solved
...
* Improved: Adding task button UX updated
* Improved: Task drawer UX updated
...
= 1.0.9 - 2025-03-20 =
* Upgrade: Updated UI/UX with improved performance a,nd experiance
* New: Attachment can now upload into task drawer
* New: Added workspace button add into workspace drawer
* Upgrade: Priority by project implemented
* New: Priority can be edited/updated/deleted
* New: Tooltip added for increased accessibility
* Upgrade: Improved member adding to workspace and projects
* New: Searching option added inside projects
* New: Frontend portal added and linked under profile
