...
// console.log(subtask, taskData);
  return (
    <> 
        ...
        {view === 'cardView' ? (
            <div onDoubleClickCapture={()=>{handleEditSubTaskDrawerOpen()}} className="sabtask mb-2" >
                <div className="flex single-task-content sub-task items-center gap-2 justify-between">
                    <TaskName taskId={subtask && subtask.id} view='cardView' isSubtask nameOfTask={subtask && subtask.name ? subtask.name : "Untitled Subtask"} />
            ...
            <div onDoubleClickCapture={()=>{handleEditSubTaskDrawerOpen()}} className="sabtask" >
                <div className="flex single-task-content sub-task">
                    <div className="task-name w-[30%] pr-4 items-center"> 
                        <div className="flex gap-2 items-center ml-2">
                            ...
                            <TaskName taskId={subtask && subtask.id} isSubtask nameOfTask={subtask && subtask.name ? subtask.name : "Untitled Subtask"} />
                        </div>
                    </div>
      ...
      {subTaskEditDrawerOpen && <EditTaskDrawer task={subtask} taskEditDrawerOpen={subTaskEditDrawerOpen} openTaskEditDrawer={openSubTaskEditDrawer} closeTaskEditDrawer={closeSubTaskEditDrawer} />}
