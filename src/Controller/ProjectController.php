...
final class ProjectController {
	...
	const TABLE_PROJECTS = PMS_TABLE_PREFIX . 'projects';
	...
	public function create(WP_REST_Request $request){
		...
		$slug = SlugGenerator::slug($name, self::TABLE_PROJECTS, 'slug' );
	...
	public function update(WP_REST_Request $request){
		...
		if(isset($requestData['slug'])){
			$newSlug = SlugGenerator::slug($requestData['name'], self::TABLE_PROJECTS, 'slug' );
	...
	public function createProjectPriority(WP_REST_Request $request){
		...
		$db->insert(PMS_TABLE_PREFIX . 'project_priorities', array(
	...
	public function getProjectPriorities($projectId){
		global $wpdb;
		$db = DatabaseTableSchema::get_global_wp_db($wpdb);
		$priorityTable = PMS_TABLE_PREFIX . 'project_priorities';
	...
	public function getTaskSectionsByProjectId($projectId){
		...
		$tableName = PMS_TABLE_PREFIX . 'task_sections';
